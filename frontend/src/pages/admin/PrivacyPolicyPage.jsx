				...
				<div className="card">
					<div className="card-body">
						...
						<div>
							...
							<ul className="list-styled mb-3">
								<li className="d-flex align-items-baseline mb-2">
									...
									<span className="fw-medium text-gray-9 me-1">Employee Data :</span>Name, contact information,
									job title, department, payroll details, and other employment-related data.
								</li>
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i>
									<span className="fw-medium text-gray-9 me-1">Login Information :</span>Username, password, IP address, and other access credentials.
								</li>
								<li className="d-flex align-items-baseline">
									<i className="ti ti-point-filled fs-10 me-1"></i>
									<span className="fw-medium text-gray-9 me-1">Usage Data : </span>Details about how the platform is used, including logs of actions taken within the HR admin module
								</li>
							</ul>
						</div>
						<div>
						...
						<div>
							...
							<p>
								We may update this policy from time to time. The latest version will always be available on the platform.
