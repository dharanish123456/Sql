        ...
        {/* Breadcrumb */}
				<div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					...
					<div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						<div className="mb-2">
							<Link to="#" className="btn btn-dark d-flex align-items-center"><i
									className="ti ti-download me-2"></i>Download</Link>
						</div>
					</div>
				</div>
				{/* /Breadcrumb */}
				...
				<div className="d-flex justify-content-center align-items-center mb-4">
					<Link to="#" className="btn btn-primary d-flex justify-content-center align-items-center me-2"><i
							className="ti ti-printer me-2"></i>Print Invoice</Link>
					<Link to="#" className="btn btn-white d-flex justify-content-center align-items-center border"><i
							className="ti ti-copy me-2"></i>Clone Invoice</Link>
				</div>
      </div>
