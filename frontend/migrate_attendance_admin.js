...
const fileBase = "attendance-admin";
const componentName = "AttendanceAdminPage";
...
// Remove footer (SmartHR design often has a separate footer div at the bottom of .page-wrapper)
bodyHtml = bodyHtml.replace(/<div className="footer[\s\S]*?<\/div>/g, "");
// Also remove PHP footer includes
...
// Stop at body/html end if present in snippet
