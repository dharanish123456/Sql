(function ($) {
  $(document).ready(function () {
    ...
    $("#advance-8").DataTable({
      language: {
        url: "core-assets/json/German.json",
      },
    });
    $("#advance-9").DataTable({
      searching: false,
    ...
    $("#data-source-2").DataTable({
      ajax: "core-assets/ajax/arrays.txt",
    });
    var dataSet = [
      [
        "Tiger Nixon",
    ...
    $("#data-source-4").DataTable({
      ...
      ajax: "core-assets/json/server-side.json",
    });
    ...
    $("#ajax-data-object").DataTable({
      ajax: "core-assets/ajax/object.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#ajax-data-nested-object").DataTable({
      processing: true,
      ajax: "core-assets/ajax/object_nested.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#orthogonal-data").DataTable({
      ajax: "core-assets/ajax/orthogonal.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#server-side-datatable").DataTable({
      processing: true,
      serverSide: true,
      ajax: "core-assets/ajax/server-processing.php",
    });
    ...
    $("#datatable-http").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "core-assets/ajax/server-processing.php",
        data: function (d) {
          d.myKey = "myValue";
        },
      },
