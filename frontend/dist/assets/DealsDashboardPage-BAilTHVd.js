import{j as e,P as c}from"./index-BpSeUKQc.js";import{u as n,E as v}from"./apiClient-Bn4Q3uRe.js";import{c as o}from"./crmService-C1GYmF3s.js";const t={html:String.raw`<div class="content">
							...
							<div class="col-sm-6">
								<div class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative">
									<div class="card-body">
										...
										<p class="fw-medium fs-13"><span class="text-danger fs-12"><i class="ti ti-arrow-wave-right-up me-1"></i>-4.01% </span> from last week</p>
									</div>
								</div>
								<div class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative">
									<div class="card-body">
										...
										<p class="fw-medium fs-13"><span class="text-success fs-12"><i class="ti ti-arrow-wave-right-up me-1"></i>+20.01% </span> from last week</p>
									</div>
								</div>
								<div class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative">
									<div class="card-body">
										...
										<p class="fw-medium fs-13"><span class="text-success fs-12"><i class="ti ti-arrow-wave-right-up me-1"></i>+55% </span> from last week</p>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
									...
									<div class="card-body">
										<div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
											...
											<div class="avatar avatar-md br-10 icon-rotate bg-info">
												<span class="d-flex align-items-center"><i class="ti ti-swipe text-white fs-16"></i></span>
											</div>
										</div>
										<div class="progress progress-xs mb-2">
											<div class="progress-bar bg-info" role="progressbar" style="width: 40%"></div>
										</div>
										<p class="fw-medium fs-13"><span class="text-danger fs-12"><i class="ti ti-arrow-wave-right-up me-1"></i>-6.01% </span> from last week</p>
									</div>
								</div>
								<div class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative">
									<div class="card-body">
										<div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
											...
											<div class="avatar avatar-md br-10 icon-rotate bg-warning">
												<span class="d-flex align-items-center"><i class="ti ti-star text-white fs-16"></i></span>
											</div>
										</div>
										<div class="progress progress-xs mb-2">
											<div class="progress-bar bg-warning" role="progressbar" style="width: 40%"></div>
										</div>
										<p class="fw-medium fs-13"><span class="text-danger fs-12"><i class="ti ti-arrow-wave-right-up me-1"></i>-3.22% </span> from last week</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card flex-fill">
							<div class="card-header">
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
									...
									<div>
										<a href="countries.php" class="btn btn-light btn-sm px-3">View All</a>
									</div>
								</div>
							</div>
											...
											<tr>
												<td class="px-0">
													<div class="d-flex align-items-center mb-2">
														<a href="countries.php" class="avatar rounded-circle border border-2">
															<img src="assets/img/payment-gateway/country-01.svg" class="img-fluid rounded-circle" alt="img">
														</a>
														<div class="ms-2">
															<h6 class="fw-medium mb-1"><a href="countries.php">USA</a></h6>
											...
											<tr>
												<td class="px-0">
													<div class="d-flex align-items-center mb-2">
														...
														<div class="ms-2">
															<h6 class="fw-medium mb-1"><a href="countries.php">UAE</a></h6>
											...
											<tr>
												<td class="px-0">
													<div class="d-flex align-items-center mb-2">
														...
														<div class="ms-2">
															<h6 class="fw-medium mb-1"><a href="countries.php">Singapore</a></h6>
											...
											<tr>
												<td class="px-0">
													<div class="d-flex align-items-center mb-2">
														...
														<div class="ms-2">
															<h6 class="fw-medium mb-1"><a href="countries.php">France</a></h6>
											...
											<tr>
												<td class="px-0">
													<div class="d-flex align-items-center">
														...
														<div class="ms-2">
															<h6 class="fw-medium mb-1"><a href="countries.php">Norway</a></h6>
															<span class="fs-13 d-inline-flex align-items-center">Deals : 221</span>
														</div>
													</div>
												</td>
						...
						<div class="card flex-fill">
							...
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between mb-4">
									...
									<div class="d-flex align-items-center">
										<a href="#" class="btn btn-light btn-icon btn-sm"><i class="ti ti-mail-bolt fs-16"></i></a>
									</div>
								</div>
								<div class="d-flex align-items-center justify-content-between mb-4">
									<div class="d-flex align-items-center">
									...
									<div class="d-flex align-items-center"><a href="#" class="btn btn-light btn-icon btn-sm"><i class="ti ti-phone fs-16"></i></a>
									</div>
								</div>
								<div class="d-flex align-items-center justify-content-between mb-4">
									<div class="d-flex align-items-center">
								...
								<div class="table-responsive">
									<table class="table table-nowrap dashboard-table mb-0">
										...
										<tbody>
											<tr>
												<td>
													<h6 class="fw-medium"><a href="deals-details.php">Collins</a></h6>
												</td>
											...
											<tr>
												<td>
													<h6 class="fw-medium"><a href="deals-details.php">Konopelski</a></h6>
												</td>
												<td>Proposal Made</td>
												<td>
													$3,15,000
											...
											<tr>
												<td>
													<h6 class="fw-medium"><a href="deals-details.php">Adams</a></h6>
												</td>
												<td>Contact Made</td>
												<td>
													$8,40,000
											...
											<tr>
												<td>
													<h6 class="fw-medium"><a href="deals-details.php">Schumm</a></h6>
												</td>
												<td>Quality To Buy</td>
												<td>
													$6,10,000
											...
											<tr>
												<td>
													<h6 class="fw-medium"><a href="deals-details.php">Wisozk</a></h6>
												</td>
												<td>Presentation</td>
												<td>
													$4,70,000
							...
							<div class="card-body schedule-timeline activity-timeline">
								...
								<div class="d-flex align-items-start">
									...
									<div class="flex-fill ps-3 timeline-flow">
										<p class="fw-medium text-gray-9 mb-1"><a href="activity.php" class="d-flex align-items-center">Meeting With <img src="assets/img/users/user-58.jpg" class="avatar avatar-sm rounded-circle mx-2" alt="Img">Abraham</a></p>
										<span>09:25 PM</span>
									</div>
								</div>
							</div>
			...
			</div>`};function f(){const{data:s,isLoading:d,error:l,refetch:r}=n({queryKey:["deals-dashboard"],queryFn:o.getDealsDashboard,placeholderData:t,keepPreviousData:!0}),a=typeof s?.html=="string"&&s.html.length>0?s.html:t.html,i=typeof a=="string"&&a.length>0;return d&&!i?e.jsx(c,{}):l&&!i?e.jsx(v,{onRetry:r}):e.jsx("div",{dangerouslySetInnerHTML:{__html:a}})}export{f as default};
