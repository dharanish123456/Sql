...
const jsxFile = path.resolve(
  "C:/Users/rambo/Music/erp.svlprinters.in/frontend/src/pages/admin/AttendanceEmployeePage.jsx",
);
...
// Remove the hardcoded footer if my regex missed it
content = content.replace(/<div className="footer[\s\S]*?<\/div>/g, "");

fs.writeFileSync(jsxFile, content);
console.log("Fixed AttendanceEmployeePage.jsx");
