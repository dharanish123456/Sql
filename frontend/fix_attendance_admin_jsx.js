...
const jsxFile = path.resolve(
  "C:/Users/rambo/Music/erp.svlprinters.in/frontend/src/pages/admin/AttendanceAdminPage.jsx",
);
...
// Remove the hardcoded footer if my regex missed it in migrate_attendance_admin.js
content = content.replace(/<div className="footer[\s\S]*?<\/div>/g, "");

fs.writeFileSync(jsxFile, content);
console.log("Fixed AttendanceAdminPage.jsx");
