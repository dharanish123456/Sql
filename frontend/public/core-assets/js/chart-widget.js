(function ($) {
  ...
  var optionslinechart = {
    ...
    colors: [NexorcrmAdminConfig.primary],
    series: [
      {
  ...
  var optionslinechart2 = {
    ...
    colors: [NexorcrmAdminConfig.secondary],
    series: [
      {
        name: "series1",
        data: [70, 60, 82, 80, 60, 90, 70, 120, 50, 60, 0],
  ...
  var optionscolumnchart = {
    ...
    colors: [NexorcrmAdminConfig.secondary, "#51bb25", NexorcrmAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
  ...
  var optionsproductchart = {
    ...
    fill: {
      colors: [NexorcrmAdminConfig.primary, NexorcrmAdminConfig.secondary],
      type: "gradient",
      gradient: {
        shade: "light",
        type: "vertical",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: NexorcrmAdminConfig.primary,
          label: {
            borderColor: NexorcrmAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: NexorcrmAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsuserchart = {
    ...
    colors: [
      NexorcrmAdminConfig.primary,
      NexorcrmAdminConfig.secondary,
      "#51bb25",
      "#544fff",
    ],
    title: {
  ...
  var optionsCircle = {
    ...
    colors: [NexorcrmAdminConfig.secondary, NexorcrmAdminConfig.primary, "#51bb25"],
    responsive: [
      {
        breakpoint: 767,
        options: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [NexorcrmAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [NexorcrmAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [NexorcrmAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [NexorcrmAdminConfig.secondary],
      },
    },
    responsive: [
      {
