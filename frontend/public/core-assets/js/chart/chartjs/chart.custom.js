    ...
    datasets: [
      {
        ...
        strokeColor: NexorcrmAdminConfig.primary,
        highlightFill: "rgba(122, 112, 186, 0.6)",
        highlightStroke: NexorcrmAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40],
      },
      {
        label: "My Second dataset",
        fillColor: "rgba(72, 163, 215, 0.4)",
        strokeColor: NexorcrmAdminConfig.secondary,
        highlightFill: "rgba(72, 163, 215, 0.6)",
        highlightStroke: NexorcrmAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: NexorcrmAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    },
    {
      ...
      highlight: NexorcrmAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
    ...
    datasets: [
      {
        ...
        strokeColor: NexorcrmAdminConfig.primary,
        pointColor: NexorcrmAdminConfig.primary,
      ...
      },
      {
        ...
        strokeColor: NexorcrmAdminConfig.secondary,
        pointColor: NexorcrmAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: NexorcrmAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        strokeColor: NexorcrmAdminConfig.primary,
        pointColor: NexorcrmAdminConfig.primary,
        pointStrokeColor: NexorcrmAdminConfig.primary,
        pointHighlightFill: NexorcrmAdminConfig.primary,
