...
const jsxFile = path.resolve(
  "C:/Users/rambo/Music/erp.svlprinters.in/frontend/src/pages/admin/ScheduleTimingPage.jsx",
);
...
// Fix special characters in modal header (times -> x)
content = content.replace(
...
console.log("Fixed ScheduleTimingPage.jsx");
