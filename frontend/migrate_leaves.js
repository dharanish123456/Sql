...
const fileBase = "leaves";
const componentName = "LeavesPage";
...
bodyHtml = bodyHtml.replace(/selected=""/g, "defaultChecked"); // checkbox/radio
bodyHtml = bodyHtml.replace(/selected(?!\w)/g, "defaultValue"); // select options - often just "selected" in HTML

// Fix defaultValue for inputs
