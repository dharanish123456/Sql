...
const jsxFile = path.resolve(
  "C:/Users/rambo/Music/erp.svlprinters.in/frontend/src/pages/admin/PerformanceReviewPage.jsx",
);
...
content = content.replace(
  /<select className="form-control select">/g,
  '<select className="form-select">',
);
...
console.log("Fixed PerformanceReviewPage.jsx");
