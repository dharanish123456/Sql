import{j as s,P as o}from"./index-BpSeUKQc.js";import{u as d,E as n}from"./apiClient-Bn4Q3uRe.js";import{c as m}from"./crmService-C1GYmF3s.js";const t={html:String.raw`<div class="content">
			...
			</div>`};function g(){const{data:i,isLoading:l,error:e,refetch:c}=d({queryKey:["chat"],queryFn:m.getChat,placeholderData:t,keepPreviousData:!0}),a=typeof i?.html=="string"&&i.html.length>0,r=a?i:t;return l&&!a?s.jsx(o,{}):e&&!a?s.jsx(n,{onRetry:c}):s.jsx("div",{dangerouslySetInnerHTML:{__html:r.html}})}export{g as default};
