...
// Fix breadcrumb link
content = content.replace(/<a href="\/employees">/g, '<Link to="/employees">');
content = content.replace(
  /<Link to="\/employees">([\s\S]*?)<\/a>/g,
  '<Link to="/employees">$1</Link>',
);
...
console.log("Fixed EmployeeDetailsPage.jsx");
