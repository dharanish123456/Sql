...
@Entity
@Table(name = "stock_request_chat_message")
public class StockRequestChatMessage {
    ...
    private StockRequestChatThread thread;
    ...
    public StockRequestChatThread getThread() { return thread; }
    public void setThread(StockRequestChatThread thread) { this.thread = thread; }
